...
namespace SeeSharpTools.JXI.SignalProcessing.GeneralSpectrum1
{
    ...
    /// </summary>
    public enum SpectrumOutputUnit1 : int
    {
        /// <summary>
        /// Voltage
        /// </summary>
    ...
    internal struct UnitConvSetting
    {
        ...
        public SpectrumOutputUnit1 Unit;
        ...
        public UnitConvSetting(SpectrumOutputUnit1 unit = SpectrumOutputUnit1.dBV, PeakScaling peakScaling = PeakScaling.Rms,
    ...
    /// 频谱平均方式定义
    /// </summary>
    public enum SpectrumAverageMode1
    {
        /// <summary>
        /// 无平均
        /// </summary>
    ...
    /// </summary>
    public enum SpectrumWeightingType1
    {
        /// <summary>
        /// 线性滑动
        /// </summary>
    ...
    /// 频谱单位信息
    /// </summary>
    public class SpectrumUnitInfo1
    {
        /// <summary>
        /// 单位类型
        /// </summary>
        public SpectrumOutputUnit1 Type { get; set; }
    ...
    {
        private GeneralSpectrumTask1 a;
        /// <summary>
        /// 默认构造函数
        ///summary>
        public SpectrumOutput(GeneralSpectrumTask1 task)
        {
            a = task;
            CenterFrequency = -1;
            Bandwidth = -1;
        ...
        public int NumberOfLines
        {
            ...
            set
            {
                ...
                var isRealType = InputDataType1.Real == a.InputDataType1;
    ...
    public class SpectrumAverage
    {
        ...
        /// 默认构造函数
        /// </summary>
        public SpectrumAverage(GeneralSpectrumTask1 task)
        {
            a = task;
            Mode = SpectrumAverageMode1.NoAveraging;
            WeightingType = SpectrumWeightingType1.LinearMoving;
            Size = 1;
        }
        ...
        private SpectrumAverageMode1 _mode;
        /// <summary>
        /// 平均方式
        /// </summary>
    ...
    /// 频谱计算相关信息
    /// </summary>
    public class SpectralInformation1
    {
        /// <summary>
        /// 默认构造函数
        /// </summary>
        public SpectralInformation1()
        {
            FreqStart = 0;
            FreqDelta = 0;
            FFTSize = 0;
